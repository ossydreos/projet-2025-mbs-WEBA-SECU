...
class FCMNotificationService {
  ...
  StreamSubscription<DocumentSnapshot<Map<String, dynamic>>>? _reservationStatusSubscription;
  ...
  Future<void> _createNotificationChannel() async {
    if (Platform.isAndroid) {
      final AndroidNotificationChannel channel = AndroidNotificationChannel(
        ...
        description: 'Notifications avec son répétitif pour les nouvelles réservations',
  ...
  Future<void> _configureFCM() async {
    ...
    print('🔔 FCMNotificationService: Statut permission: ${settings.authorizationStatus}');
  ...
  Future<void> _handleForegroundMessage(RemoteMessage message) async {
    print('🔔 FCMNotificationService: Message reçu au premier plan: ${message.data}');
  ...
  static Future<void> _handleBackgroundMessage(RemoteMessage message) async {
    print('🔔 FCMNotificationService: Message reçu en arrière-plan: ${message.data}');
  ...
  Future<void> _handleMessageOpenedApp(RemoteMessage message) async {
    print('🔔 FCMNotificationService: App ouverte depuis notification: ${message.data}');
  ...
  Future<void> startUberStyleNotification({
    ...
    print('🔔 FCMNotificationService: Démarrage notification Uber style pour $clientName');
  ...
  Future<void> _showLocalNotification(String clientName, String reservationId) async {
    print('🔔 FCMNotificationService: Affichage notification locale');
    
    final AndroidNotificationDetails androidDetails = AndroidNotificationDetails(
      'uber_style_channel_v3',
      'Notifications Uber Style',
      channelDescription: 'Notifications avec son répétitif pour les nouvelles réservations',
      importance: Importance.high,
